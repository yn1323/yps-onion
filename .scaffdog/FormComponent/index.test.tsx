import { {{ inputs.component | pascal }}Inner } from '@/components/{{ inputs.path }}/{{ inputs.component | pascal }}';
...
describe('{{ inputs.component | pascal }} Components', () => {
  ...
  describe('Submit', () => {
    ...
    test('Submit validation', async () => {
      const { result } = renderHook(() => use{{ inputs.component | pascal }}());
      render(
        <{{ inputs.component | pascal }}Inner
